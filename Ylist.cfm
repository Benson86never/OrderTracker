	...
	<body>
		...
		<cfoutput>
			...
			<cfloop array="#Lists#" index="list" >
				<div><li /><a href="#cgi.script_name#?ListID=#list.getID()#">#list.getName()#</a></div>
	<cfif isDefined("url.ListID")>
			...
			<cfloop array="#Lists#" index="list" >
				...
				<cfloop array="#list.getitem()#" index="item" >
					...
					<input type="text" name="#item.getid()#;#supplierArray[1].getid()#;ITEM" size="3">
					#supplierArray[1].getid()#
					#item.getname()# #item.getid()# #supplierArray[1].getid()# #supplierArray[1].getname()#<br />
				</cfloop>
			...
			<!---New list loop--->	
				...
				<cfloop array="#item.supplier#" index="supplier">
					...
					<cfif isDefined('url.SupplierID') and url.SupplierID is supplier.getid()>
