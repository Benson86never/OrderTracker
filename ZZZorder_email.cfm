...
<cfmail from="orders@porthousegrill.com" subject="#SubaccountName# order #OrderID#" to="#EmailList#" cc="#CCEmail#" type="text/html">
...
<cfcatch>
 <cfmail from="orders@porthousegrill.com" subject="Port House Grill order mail error" to="#CCEmail#" type="text/html">
